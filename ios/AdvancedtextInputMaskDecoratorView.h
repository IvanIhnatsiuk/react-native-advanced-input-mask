...
@interface AdvancedTextInputMaskDecoratorView : RCTViewComponentView<AdvancedTextInputViewContainerDelegate>
@end
...
namespace facebook {
    namespace react {
        ...
        bool operator==(const AdvancedTextInputMaskDecoratorViewCustomNotationsStruct& a, const AdvancedTextInputMaskDecoratorViewCustomNotationsStruct& b)
        {
            return b.character == a.character && b.characterSet == a.characterSet && b.isOptional == a.isOptional;
        }
    }
}
